...
<body>
    ...
    <nav id="nafocolor" class="navbar navbar-light navbar-expand-md pl-5 pr-5 mb-5">
        ...
        <a href="{{ route('ver_carrinho') }}" class="btn btn-sm p-3" id="a"> <i
    ...
    <div class="container">
        <div class="row" style="margin:5%">
            ...
            @if (\Auth::user())
                <div class="col-12">
                    <p class="text-right">Seja bem vindo(a), {{ \Auth::user()->nome }}, <a
          ...
          <div class="container text-center text-md-start mt-5">
              <div class="row mt-3">
                  <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                      ...
                      <p>
                          A vida é feita de momentos e de sabores, aproveite cada sabor ao lado de alguem que você
                          ame.
                      </p>
                  </div>
